# see: https://github.com/closeheat/pytorch-lstm-text-generation-tutorial
...
class Dataset(torch.utils.data.Dataset):
    ...
    def load_words(self):
        train_df = pd.read_csv(str(Path.cwd() / "data" / "reddit-cleanjokes.csv"))
        text = train_df["Joke"].str.cat(sep=" ")
        return text.split(" ")

    def get_uniq_words(self):
        word_counts = Counter(self.words)
        return sorted(word_counts, key=word_counts.get, reverse=True)  # type: ignore
